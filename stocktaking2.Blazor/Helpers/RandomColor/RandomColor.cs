...
namespace stocktaking2.Blazor.Helpers.RandomColor
{
    public static class RandomColor
    {
        ...
        public static string[] GetColorsArray(ColorScheme scheme, Luminosity luminosity, int count)
        {
            var ret = new string[count];
            for (var i = 0; i < count; i++)
            {
                ret[i] = ColorTranslator.ToHtml(GetColor(scheme, luminosity));
            }
            return ret;
        }
